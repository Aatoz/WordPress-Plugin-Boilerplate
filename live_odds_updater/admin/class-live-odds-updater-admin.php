 ...
 * @subpackage live_odds_updater/admin
 */
...
class live_odds_updater_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $live_odds_updater       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style($this->live_odds_updater, plugin_dir_url(__FILE__) . "css/live-odds-updater-admin.css",
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script($this->live_odds_updater, plugin_dir_url(__FILE__) . "js/live-odds-updater-admin.js",
